...
int main() {
  ...
  donuts.push_back(Donut("glazed", 40, "shack of donuts"));
  donuts.push_back(Donut("glazed", 35, "shack of donuts"));
  donuts.push_back(Donut("glazed", 20, "shack of donuts"));
  donuts.push_back(Donut("glazed", 15, "shack of donuts"));
  donuts.push_back(Donut("glazed", 1, "shack of donuts"));
